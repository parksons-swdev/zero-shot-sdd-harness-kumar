...
export default function SummaryTable({ rows }: SummaryTableProps) {
  ...
  if (rows.length === 0) {
    return <p className="text-sm text-gray-400">No table data for this answer.</p>
  }
          ...
          <tr>
            {columns.map(col => (
              <th
                ...
                className="cursor-pointer select-none px-3 py-2 text-left text-xs font-medium tracking-wide text-gray-500 uppercase hover:text-gray-700"
              >
                {col}
