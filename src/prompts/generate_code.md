...
- If a prior attempt failed or was insufficient, you will be given its sanitized error/result summary. Do not repeat the same approach — pick a different one (e.g. a different aggregation, a different column, or a corrected type conversion).
